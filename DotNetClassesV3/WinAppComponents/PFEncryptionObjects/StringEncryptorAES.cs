...
namespace PFEncryptionObjects
{
    ...
    /// </summary>
    public class StringEncryptorAES : PFEncryptionObjects.IStringEncryptor
    {
        ...
        private byte[] _key;
        private byte[] _iv;
        private AesCryptoServiceProvider _cryptoProvider = new AesCryptoServiceProvider();
