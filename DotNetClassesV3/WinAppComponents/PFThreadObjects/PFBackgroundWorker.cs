...
namespace PFThreadObjects
{
    ...
    /// </summary>
    public class PFBackgroundWorker : BackgroundWorker
    {
        ...
        public PFBackgroundWorker(string workerName)
        {
        ...
        public PFBackgroundWorker(string workerName, string workerDescription)
        {
            _workerName = workerName;
