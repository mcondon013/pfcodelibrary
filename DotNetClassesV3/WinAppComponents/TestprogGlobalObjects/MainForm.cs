    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkTimedDialogBoxTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.TimedDialogBoxTest(this);
                }

                if (this.chkModelessDialogBoxTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.ModelessDialogBoxTest(this);
                }

                if (this.chkInputBoxTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.InputBoxTest(this);
                }
