...
namespace TestprogTimers
{
    public partial class MainForm : Form
    {
        ...
        private Tests _appprocessor = new Tests();
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkStopwatchTest.Checked)
                {
                    nNumTestsSelected++;
                    _appprocessor.StopwatchTest(this);
                }

                if (this.chkIntervalTimerTest.Checked)
                {
                    nNumTestsSelected++;
                    _appprocessor.IntervalTimerTest(this);
                }

                if (this.chkStatusTimerTest.Checked)
                {
                    nNumTestsSelected++;
                    _appprocessor.StatusTimerTest(this);
                }

                if (this.chkSystemTimerTest.Checked)
                {
                    nNumTestsSelected++;
                    _appprocessor.SystemTimerTest(this);
                }
