    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkWinAppConsoleTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.WinAppConsoleTest();
                }

                if (this.chkDynamicLoadTests.Checked)
                {
                    nNumTestsSelected++;
                    Tests.DynamicLoadTests();
                }

                if (this.chkWriteToEventLogTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.WriteToEventLogTest();
                }

                if (this.chkPrinterInfoTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.PrinterInfoTest();
                }

                if (this.chkRegistryTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.RunRegistryTest();
                }
