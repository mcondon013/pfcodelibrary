...
{
    /// <summary>
    /// Represents a dialog containing a <see cref="PrintPreviewControlExt"/> control
    ...
    /// PDF export.
    /// </remarks>
    internal partial class PrintPreviewDialogExt : Form
    {
        //--------------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="PrintPreviewDialogExt"/>.
        /// </summary>
        public PrintPreviewDialogExt() : this(null)
        {
        }
        /// <summary>
        /// Initializes a new instance of a <see cref="PrintPreviewDialogExt"/>.
        ...
        public PrintPreviewDialogExt(Control parentForm)
        {
            InitializeComponent();
            if (parentForm != null)
            {
