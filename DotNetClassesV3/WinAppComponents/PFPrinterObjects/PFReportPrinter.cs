...
{
    /// <summary>
    /// Class for printing text that is formatted as a report with column headings and report header.
    /// </summary>
    public class PFReportPrinter
    {
        ...
        //private bool _reportHeaderHasBeenPrinted = false;
        ...
        /// <summary>
        /// PageMarginTop Property.
        /// </summary>
        public int PageMarginTop
        {
            get
            {
                return this.pdoc.DefaultPageSettings.Margins.Top;
            }
            set
            {
                this.pdoc.DefaultPageSettings.Margins.Top = value;
            }
        }

        /// <summary>
        /// PageMarginLeft Property.
        /// </summary>
        public int PageMarginLeft
        {
            get
            {
                return this.pdoc.DefaultPageSettings.Margins.Left;
            }
            set
            {
                this.pdoc.DefaultPageSettings.Margins.Left = value;
            }
        }

        /// <summary>
        /// PageMarginRight Property.
        /// </summary>
        public int PageMarginRight
        {
            get
            {
                return this.pdoc.DefaultPageSettings.Margins.Right;
            }
            set
            {
                this.pdoc.DefaultPageSettings.Margins.Right = value;
            }
        }

        /// <summary>
        /// PageMarginBottom Property.
        /// </summary>
        public int PageMarginBottom
        {
            get
            {
                return this.pdoc.DefaultPageSettings.Margins.Bottom;
            }
            set
            {
                this.pdoc.DefaultPageSettings.Margins.Bottom = value;
            }
        }
        ...
        {
            SizeF headerStringSize = new SizeF();
            headerStringSize = e.Graphics.MeasureString(_title, this.Font);
            headerStringSize.Height = (float)Math.Ceiling((double)headerStringSize.Height);
            int revisedMarginTop = (pdoc.DefaultPageSettings.Margins.Top) + (int)headerStringSize.Height;
            ...
            if (pdoc.DefaultPageSettings.Landscape == false)
            {
                ...
                printAreaHeight = pdoc.DefaultPageSettings.PaperSize.Height - revisedMarginTop - pdoc.DefaultPageSettings.Margins.Bottom;
            ...
            else
            {
                ...
                printAreaHeight = pdoc.DefaultPageSettings.PaperSize.Width - revisedMarginTop - pdoc.DefaultPageSettings.Margins.Bottom;
            ...
            marginTop = revisedMarginTop; // Y coordinate
            ...
            HeaderFmt.Alignment = StringAlignment.Near;
            ...
            RectangleF rectHeaderPrintingArea = new RectangleF(marginLeft, Convert.ToSingle((marginTop - (int)headerStringSize.Height)), printAreaWidth, headerStringSize.Height);
            if (_title.Length > 0)
            {
            ...
            {
                // Print the text to the page.
                e.Graphics.DrawString(Environment.NewLine + "Page " + _pageCount.ToString("#,##0"), _font, Brushes.Black, rectFooterPrintingArea, FooterFmt);
            }
            ...
            //e.Graphics.MeasureString(combinedTextToPrint.Substring(_currentChar), _font, new SizeF(printAreaWidth, printAreaHeight), fmt, out charsFitted, out linesFilled);

            // Print the text to the page.
            e.Graphics.DrawString(_textToPrint.Substring(_currentChar), _font, Brushes.Black, printingArea, fmt);
            //e.Graphics.DrawString(combinedTextToPrint.Substring(_currentChar), _font, Brushes.Black, printingArea, fmt);
            ...
            //if (_currentChar < combinedTextToPrint.Length)
            {
            e.HasMorePages = true;
            }
            else
