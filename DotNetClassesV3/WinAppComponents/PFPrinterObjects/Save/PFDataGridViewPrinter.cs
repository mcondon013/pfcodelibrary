...
//
// Code below contains modifications necessary to accomodate ProFast Computing software requirements.
//
//****************************************************************************************************
using System;
using System.Text;
...
{
    /// <summary>
    /// Class encapsulates printer functionality for a .NET DataGridView control.
    /// </summary>
    public class PFDataGridViewPrinter
    {
        //private work variables
        private StringBuilder _msg = new StringBuilder();

        //private variables for properties
        private DGVPrinter _printer = new DGVPrinter();
        private DataGridView _dgv = null;

        //_printer.Title = "Application Settings"; ;
        //_printer.SubTitle = "Key/Value pairs used by the application"; ;
        //_printer.SubTitleFormatFlags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip; ;
        //_printer.PageNumbers = true; ;
        //_printer.ShowTotalPageNumber = true;
        //_printer.PageNumberInHeader = false; ;
        //_printer.ColumnWidth = DGVPrinter.ColumnWidthSetting.Porportional;
        //_printer.HeaderCellAlignment = StringAlignment.Near;
        //_printer.Footer = "ProFast Computing";
        //_printer.FooterSpacing = 15; ;

        private string _title = "DataGridView Report";
        private string _subTitle = "Output from the grid";
        private StringFormatFlags _subTitleFormatFlags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
        private bool _pageNumbers = true;
        private bool _showTotalPageNumber = true;
        private bool _pageNumberInHeader = false;
        private DGVPrinter.ColumnWidthSetting _columnWidth = DGVPrinter.ColumnWidthSetting.Porportional;
        private StringAlignment _headerCellAlignment = StringAlignment.Near;
        private string _footer = "DataGridView Printer";
        private float _footerSpacing = 15;
        ...
        /// Constructor.
        /// </summary>
        public PFDataGridViewPrinter(DataGridView dgv)
        {
           _dgv = dgv ;
        }
        ...
        /// <summary>
        /// The printer object encapsulated by PFDataGridViewPrinter class.
        /// </summary>
        ...
        /// <summary>
        /// Specifies instance of DataGridView to be output by this DataGridViewPrinter.
        /// </summary>
        ...
        /// <summary>
        /// SubTitleFormatFlags Property.
        /// </summary>
        public StringFormatFlags SubTitleFormatFlags
        {
            get
            {
                return _subTitleFormatFlags;
            }
            set
            {
                _subTitleFormatFlags = value;
            }
        }
        ...
        /// <summary>
        /// PageNumberInHeader Property.
        /// </summary>
        public bool PageNumberInHeader
        {
            get
            {
                return _pageNumberInHeader;
            }
            set
            {
                _pageNumberInHeader = value;
            }
        }
        ...
        /// </summary>
        public DGVPrinter.ColumnWidthSetting ColumnWidth
        {
            get
            {
                return _columnWidth;
        ...
        /// <summary>
        /// HeaderCellAlignment Property.
        /// </summary>
        public StringAlignment HeaderCellAlignment
        {
            get
            {
                return _headerCellAlignment;
            }
            set
            {
        ...
        /// <summary>
        /// FooterSpacing Property.
        /// </summary>
        public float FooterSpacing
        {
            get
            {
                return _footerSpacing;
            }
            set
            {
        ...
        /// <summary>
        /// Displays .NET PageSetupDialog. Use this to set page orientation and margins.
        /// </summary>
        public void ShowPageSettingsDialog()
        {
            PageSetupDialog psd = new PageSetupDialog();

            psd.Document = _printer.printDocument;
            psd.Document.DocumentName = "DataGridView Output";

            psd.PageSettings = _printer.printDocument.DefaultPageSettings;

            if (psd.ShowDialog() == DialogResult.OK)
            {
                _printer.printDocument.DefaultPageSettings = psd.PageSettings;
            }

        }

        /// <summary>
        /// Prints the current data grid. Dispalys .NET PrintDialog to select printer.
        /// </summary>
        public void Print()
        {
            Print(true);
        ...
        /// <summary>
        /// Prints the current data grid.
        /// </summary>
        /// <param name="showPrinterSelectDialog">If false, contents of data grid are sent directly to printer. If true, a PrintDialog is shown so that printer can be selected.</param>
        public void Print(bool showPrinterSelectDialog)
        {
            InitializePrinter();
            if (showPrinterSelectDialog)
                _printer.PrintDataGridView(this.Grid);
            else
                _printer.PrintNoDisplay(this.Grid);
        }

        /// <summary>
        /// Shows current data grid output in preview mode. Displays a PrintDialog before the preview so that the printer can be selected.
        /// </summary>
        ...
        /// <summary>
        /// Shows current data grid output in preview mode.
        /// </summary>
        /// <param name="showPrinterSelectDialog">If false, contents of data grid are sent directly to print preview. If true, a PrintDialog is shown so that printer can be selected.</param>

        public void PrintPreview(bool showPrinterSelectDialog)
        {
            InitializePrinter();
            if (showPrinterSelectDialog)
                _printer.PrintPreviewDataGridView(this.Grid);
            else
                _printer.PrintPreviewNoDisplay(this.Grid);
        }
        ...
        private void InitializePrinter()
        {
            ...
            {
                _msg.Length = 0;
                _msg.Append("No grid is attached to this DataGridViewPrinter.");
                _msg.Append(" You must set the Grid property to a valid instance of the DataGridView class.");
                throw new System.Exception(_msg.ToString());
            }
            _printer.Title = _title;
            _printer.SubTitle = _subTitle;
            _printer.SubTitleFormatFlags = _subTitleFormatFlags;
            _printer.PageNumbers = _pageNumbers;
            _printer.ShowTotalPageNumber = _showTotalPageNumber;
            _printer.PageNumberInHeader = _pageNumberInHeader;
            _printer.ColumnWidth = _columnWidth;
            _printer.HeaderCellAlignment = _headerCellAlignment;
            _printer.Footer = _footer;
            _printer.FooterSpacing = _footerSpacing;
        }
...
#pragma warning disable 1591
        ...
        /// <param name="overridewidth">User override of cell width</param>
        ...
        /// <param name="pageset">The table's print margins</param>
        ...
        private void printfooter(Graphics g, ref float pos, PageDef pageset)
        {
            ...
            pos = pageHeight - footerHeight - pageset.margins.Bottom;  // - margins.Top
            ...
            if (!pagenumberontop)
            {
                if (pageno)
                {
                    ...
                    printsection(g, ref pos, pagenumber, pagenofont, pagenocolor, pagenumberformat,
                        overridepagenumberformat, pageset, null, null);
                }
            }
        }
        ...
        /// </summary>
        /// <param name="g">Graphics Context to print within</param>
        /// <param name="finalpos">Track vertical space used; 'y' location</param>
        /// <param name="row">The row that will be printed</param>
        /// <param name="pageset">Current Pageset - defines columns and margins</param>
        /// <param name="startlocation">Line no. in row to start printing text at</param>
