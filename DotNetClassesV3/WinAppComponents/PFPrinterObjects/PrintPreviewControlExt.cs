...
//Code downloaded from CodeProject and modified for ProFast
//Original code author: Bernardo Castilho, Chief Technology Officer, ComponentOne (Oct. 4, 2013)
namespace PFPrinterObjects
{
    /// <summary>
    /// Specifies the zoom mode for the <see cref="PrintPreviewControlExt"/> control.
    /// </summary>
    internal enum ZoomMode
    {
        ...
        TwoPages,
        /// <summary>
        /// Use the zoom factor specified by the <see cref="PrintPreviewControlExt.Zoom"/> property.
        /// </summary>
        Custom
    }
    ...
    /// </remarks>
    internal class PrintPreviewControlExt : UserControl
    {
        //-------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="PrintPreviewControlExt"/> control.
        /// </summary>
        public PrintPreviewControlExt()
        {
        ...
        internal class DocumentPrinter : PrintDocument
        {
            ...
            public DocumentPrinter(PrintPreviewControlExt preview, int first, int last)
            {
