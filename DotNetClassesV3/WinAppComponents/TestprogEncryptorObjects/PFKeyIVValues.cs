...
namespace pfEncryptorObjects
{
    ...
    /// </summary>
    public class PFKeyIVValues
    {
        //private work variables
        private StringBuilder _msg = new StringBuilder();

        //private variables for properties
        private pfEncryptionAlgorithm _alg = pfEncryptionAlgorithm.NotSpecified;
        ...
        /// Constructor.
        /// </summary>
        public PFKeyIVValues(string key, string iv)
        {
            _key = key;
            _iv = iv;
        }
        ...
        /// Algorithm property.
        /// </summary>
        public pfEncryptionAlgorithm Algorithm
        {
            get
            {
                return _alg;
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFKeyIVValues));
        ...
        /// <returns>An instance of PFKeyIVValues.</returns>
        public static PFKeyIVValues LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFKeyIVValues));
            TextReader textReader = new StreamReader(filePath);
            PFKeyIVValues objectInstance;
            objectInstance = (PFKeyIVValues)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of PFKeyIVValues.</returns>
        public static PFKeyIVValues LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFKeyIVValues));
            StringReader strReader = new StringReader(xmlString);
            PFKeyIVValues objectInstance;
            objectInstance = (PFKeyIVValues)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
