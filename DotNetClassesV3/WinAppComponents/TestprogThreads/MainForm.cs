    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkWaitTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.WaitTest();
                }

                if (this.chkPFThreadTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.PFThreadTest();
                }

                if (this.chkPFThreadTaskTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.PFThreadTaskTest();
                }

                if (this.chkMultiplePFThreadTaskTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.MultiplePFThreadTaskTest();
                }
