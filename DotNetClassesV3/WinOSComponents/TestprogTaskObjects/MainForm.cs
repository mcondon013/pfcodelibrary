    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkTaskManagerSaveAndLoadTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.TaskManagerSaveAndLoadTest(this);
                }

                if (this.chkInitTaskProcessorTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.InitTaskProcessorTest(this);
                }
