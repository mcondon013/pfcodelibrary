    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkOneTimeScheduleTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.OneTimeScheduleTest(this);
                }

                if (this.chkDailyScheduleTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.DailyScheduleTest(this);
                }

                if (this.chkVerifyDailyScheduleTimesTest.Checked)
                {
                    nNumTestsSelected++;
                    Tests.VerifyDailyScheduleTimesTest(this);
                }
