...
namespace TestprogSQLCE35
{
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            {
                DisableFormControls();
                Tests35.SaveErrorMessagesToAppLog = _saveErrorMessagesToAppLog;
                ...
                {
                    numTestsSelected++;
                    Tests35.CreateDatabaseTest(this);
                }

                if (this.chkImportDataTable.Checked)
                {
                    numTestsSelected++;
                    Tests35.ImportDataTableTest(this);
                }

                if (this.chkCreateTable.Checked)
                {
                    numTestsSelected++;
                    Tests35.CreateTableTest(this);
                }

                if (this.chkConnectionTest.Checked)
                {
                    numTestsSelected++;
                    Tests35.ConnectionTest(this);
                }
        ...
        public void RunQueryBuilder()
        {
            ...
            qbf.DatabasePlatform = QueryBuilderDatabasePlatform.SQLServerCE;
