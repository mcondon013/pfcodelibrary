    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.txtServerName.Text = "PROFASTSV4MYSQL";
                this.txtDatabaseName.Text = "SAKILA";
                this.txtPortNumber.Text = "3306";
                this.txtUsername.Text = "Mike";
                this.txtPassword.Text = "MIKE92";
                this.txtConnectionString.Text = string.Empty;

                this.txtSQLQuery.Text = "SELECT ID as nbr, name, country, city, \"zip code\", phone FROM sakila.customer_list";
        ...
        private void LoadAppConfigItems()
        {
            ...
            DataTable dt = keyValsDataSet.Tables["SAKILA.KeyValTable"];
            dt.Clear();
        ...
        public void RunQueryBuilder()
        {
            ...
            qbf.DatabasePlatform = QueryBuilderDatabasePlatform.MySQL;
