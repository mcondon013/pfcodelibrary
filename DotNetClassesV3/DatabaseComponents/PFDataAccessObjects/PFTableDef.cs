...
namespace PFDataAccessObjects
{
    ...
    public class PFTableDef
    {
        ...
        private string _tableOwner = string.Empty;
        private string _tableName = string.Empty;
        private string _tableCreateStatement = string.Empty;
        private DataTable _tableObject = null;
        ...
        public string TableCreateStatement
        {
            get
            {
                return _tableCreateStatement;
            }
            set
            {
                _tableCreateStatement = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFTableDef));
        ...
        public static PFTableDef LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFTableDef));
            TextReader textReader = new StreamReader(filePath);
            PFTableDef objectInstance;
            objectInstance = (PFTableDef)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of PFTableDef.</returns>
        public static PFTableDef LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFTableDef));
            StringReader strReader = new StringReader(xmlString);
            PFTableDef objectInstance;
            objectInstance = (PFTableDef)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
