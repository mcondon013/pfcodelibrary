    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.txtServerName.Text = "PROFASTSV2SYB";
                this.txtPort.Text = "5000";
                this.txtDatabaseName.Text = "AdventureWorks";
                //this.txtDatabaseName.Text = "Pubs2";
                this.txtUsername.Text = "SA";
                this.txtPassword.Text = "SA1992";

                this.txtTableName.Text = "TestTableSYB";
        ...
        public void RunQuickTests()
        {
            ...
            try
            {
                ...
                Program._messageLog.WriteLine("No QuickTests defined.");
        ...
        public void RunQueryBuilder()
        {
            ...
            qbf.DatabasePlatform = QueryBuilderDatabasePlatform.Sybase;
