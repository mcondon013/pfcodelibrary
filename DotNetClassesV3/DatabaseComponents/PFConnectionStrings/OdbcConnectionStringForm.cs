...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class OdbcConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        private PFOdbc _db = new PFOdbc();

        private string _saveDsnName = string.Empty;
        private string _saveDriverName = string.Empty;

        //private variables for properties
        DatabasePlatform _dbPlatform = DatabasePlatform.ODBC;
        ...
        /// Constructor.
        /// </summary>
        public OdbcConnectionStringForm()
        {
            InitializeComponent();
        }
...
#pragma warning disable 1591
        ...
        {
            _saveDsnName = this.txtDsnName.Text;
            _saveDriverName = this.txtDriverName.Text;
        }
        ...
        private bool FormFieldsHaveChanged()
        {
            ...
            if (_saveDsnName != this.txtDsnName.Text
                || _saveDriverName != this.txtDriverName.Text)
            {
                retval = true;
            }
        ...
        private bool UpdateConnectionProperties()
        {
            ...
            _connectionName = this.txtConnectionName.Text;
            _connectionString = this.txtConnectionString.Text;
            //DO NOT PROMPT TO REBUILD FOR ODBC, even if either dsn or driver parameter has changed. User must specifically use Build button. In most cases connection string must be manually input for odbc: parameters on from are not enough.
        ...
        private string BuildConnectionString()
        {
            ...
            _db.Dsn = this.txtDsnName.Text;
            _db.Driver = this.txtDriverName.Text;
        ...
        {
            _db.ConnectionString = this.ConnectionString;
            this.txtDsnName.Text = _db.Dsn;
            this.txtDriverName.Text = _db.Driver;
        }
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "ODBC Connection Strings");
        }
