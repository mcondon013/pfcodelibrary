...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class DB2ConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        DatabasePlatform _dbPlatform = DatabasePlatform.DB2;    //TODO: DONE
        ...
        /// Constructor.
        /// </summary>
        public DB2ConnectionStringForm()
        {
            InitializeComponent();
        }
...
#pragma warning disable 1591
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "DB2 Connection Strings");
        }
