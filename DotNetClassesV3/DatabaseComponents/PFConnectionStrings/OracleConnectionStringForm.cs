...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class OracleConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        DatabasePlatform _dbPlatform = DatabasePlatform.OracleNative;    //TODO: DONE
        ...
        /// Constructor.
        /// </summary>
        public OracleConnectionStringForm()
        {
            InitializeComponent();
        }
...
#pragma warning disable 1591
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "Oracle Native Connection Strings");
        }
