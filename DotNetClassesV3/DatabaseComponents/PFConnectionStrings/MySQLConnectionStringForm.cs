...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class MySQLConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        DatabasePlatform _dbPlatform = DatabasePlatform.MySQL;    //TODO: DONE
...
#pragma warning disable 1591
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "MySQL Connection Strings");
        }
