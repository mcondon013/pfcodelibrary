...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class SQLServerCE35ConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        DatabasePlatform _dbPlatform = DatabasePlatform.SQLServerCE35;    //TODO: Changed
        ...
        /// Constructor.
        /// </summary>
        public SQLServerCE35ConnectionStringForm()
        {
            InitializeComponent();
        }
...
#pragma warning disable 1591
        ...
        private string BuildConnectionString()
        {
            ...
            _db.SetPropertyValue("EncryptionMode", (SQLCE35EncryptionMode)Enum.Parse(typeof(SQLCE35EncryptionMode), this.cboEncryptionMode.Text));
            _db.SetPropertyValue("MaxDatabaseSize", PFTextProcessor.ConvertStringToInt(this.txtMaxDatabaseSize.Text, (int)enSQLCE35Defaults.MaxDatabaseSize));
            _db.SetPropertyValue("MaxBufferSize", PFTextProcessor.ConvertStringToInt(this.txtMaxBufferSize.Text, (int)enSQLCE35Defaults.MaxBufferSize));
            _db.SetPropertyValue("MaxTempFileSize", PFTextProcessor.ConvertStringToInt(this.txtMaxTempFileSize.Text, (int)enSQLCE35Defaults.MaxTempFileSize));
            //END TODO 
        ...
        {
            string sampleCE35ZipFile = Path.Combine(_desktopDbFolder, "SampleOrderDataCE35.zip");
            string sampleCE35Folder = _desktopDbFolder;
            string sampleCE35File = Path.Combine(_desktopDbFolder, "SampleOrderDataCE35.sdf");

            if (File.Exists(sampleCE35File) == false)
            {
                if (File.Exists(sampleCE35ZipFile))
                {
                    ZipArchive za = new ZipArchive(sampleCE35ZipFile);
                    za.ExtractAll(sampleCE35Folder);
                    za = null;
                }
            }
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "SQLCE 3.5 Connection Strings");
        }
