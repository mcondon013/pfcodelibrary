...
namespace PFConnectionStrings
{
    ...
    /// </summary>
    public partial class SybaseConnectionStringForm : Form, IConnectionStringForm
    {
        ...
        private string _savePort = string.Empty;

        //private variables for properties
        DatabasePlatform _dbPlatform = DatabasePlatform.Sybase;    //TODO: DONE
        ...
        /// Constructor.
        /// </summary>
        public SybaseConnectionStringForm()
        {
            InitializeComponent();
        }
...
#pragma warning disable 1591
        ...
        private string BuildConnectionString()
        {
            ...
            _db.SetPropertyValue("Port", this.txtPort.Text);
            //END TODO
        ...
        private void FillPropertiesFromConnectionString()
        {
            ...
            this.txtPort.Text = _db.GetPropertyValue("Port").ToString();
            //END TODO
        }
        ...
        {
            if (HelpFileExists())
                Help.ShowHelp(this, _helpFilePath, HelpNavigator.KeywordIndex, "Sybase Connection Strings");
        }
