...
namespace PFConnectionObjects
{
    ...
    /// </summary>
    public class PFProviderDefinition
    {
        ...
        private DatabasePlatform _databasePlatform = DatabasePlatform.Unknown;
        private string _invariantName = string.Empty;
        private string _assemblyNamespace = string.Empty;
        private string _assemblyName = string.Empty;
        private enProviderInstallationStatus _installationStatus = enProviderInstallationStatus.Unknown;
        private bool _availableForSelection = false;
        ...
        public enProviderInstallationStatus InstallationStatus
        {
            get
            {
        ...
        public bool AvailableForSelection
        {
            get
            {
                return _availableForSelection;
            }
            set
            {
                _availableForSelection = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFProviderDefinition));
        ...
        public static PFProviderDefinition LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFProviderDefinition));
            TextReader textReader = new StreamReader(filePath);
            PFProviderDefinition objectInstance;
            objectInstance = (PFProviderDefinition)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of PFProviderDefinition.</returns>
        public static PFProviderDefinition LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFProviderDefinition));
            StringReader strReader = new StringReader(xmlString);
            PFProviderDefinition objectInstance;
            objectInstance = (PFProviderDefinition)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
