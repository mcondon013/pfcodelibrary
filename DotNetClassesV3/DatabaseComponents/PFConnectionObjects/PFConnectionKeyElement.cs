...
namespace PFConnectionObjects
{
    ...
    /// </summary>
    public class PFConnectionKeyElement
    {
        ...
        private string[] _selectionValues = new string[1] {string.Empty};
        ...
        public PFConnectionKeyElement(string key, string val)
        {
            enConnectionStringValuePrompt valuePrompt = enConnectionStringValuePrompt.TextBox;
            string[] selectionValues = new string[1] { string.Empty };
            InitInstance(key, val, valuePrompt, selectionValues);
        }
        ...
        public PFConnectionKeyElement(string key, string val, enConnectionStringValuePrompt valuePrompt)
        {
        ...
        public PFConnectionKeyElement(string key, string val, enConnectionStringValuePrompt valuePrompt, string[] selectionValues)
        {
            InitInstance(key, val, valuePrompt, selectionValues);
        }

        private void InitInstance(string key, string val, enConnectionStringValuePrompt valuePrompt, string[] selectionValues)
        {
            _key = key;
            _val = val;
            _valuePrompt = valuePrompt;
        ...
        /// </summary>
        public enConnectionStringValuePrompt ValuePrompt
        {
            get
            {
                return _valuePrompt;
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFConnectionKeyElement));
        ...
        public static PFConnectionKeyElement LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFConnectionKeyElement));
            TextReader textReader = new StreamReader(filePath);
            PFConnectionKeyElement columnDefinitions;
            columnDefinitions = (PFConnectionKeyElement)deserializer.Deserialize(textReader);
            textReader.Close();
