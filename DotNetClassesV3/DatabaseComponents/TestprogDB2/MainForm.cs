...
namespace TestprogDB2
{
    public partial class MainForm : Form
    {
        ...
        private void chkIsInformixDB_CheckedChanged(object sender, EventArgs e)
        {
            IsInformixDB_CheckedChanged();
        }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.txtServerName.Text = "PROFASTSV4DB2";
                this.txtDatabaseName.Text = "SAMPLE";
                this.txtPortNumber.Text = "50000";
                this.txtUsername.Text = "DB2ADMIN";
                this.txtPassword.Text = "DB21992";
                this.txtConnectionString.Text = string.Empty;

                this.txtSQLQuery.Text = "SELECT EMPNO AS NBR, LASTNAME, FIRSTNME, WORKDEPT AS DEP, PHONENO AS PH, HIREDATE, SEX AS X, EDLEVEL AS LV FROM MIKE.EMPLOYEE";
        ...
        private void LoadAppConfigItems()
        {
            ...
            DataTable dt = keyValsDataSet.Tables["Mike.KeyValTable"];
            dt.Clear();
        ...
        public void RunQueryBuilder()
        {
            ...
            /*
                        ...
                        if (chkIsInformixDB.Checked == false)
                            qbf.DatabasePlatform = QueryBuilderDatabasePlatform.DB2;
                        else
        ...
        private void IsInformixDB_CheckedChanged()
        {
            if (chkIsInformixDB.Checked)
            {
