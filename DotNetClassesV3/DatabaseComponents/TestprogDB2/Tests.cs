...
namespace TestprogDB2
{
    public class Tests
    {
        ...
        public static void CreateTableTest(MainForm frm)
        {
            ...
            string tableName = "MIKE.TESTTABLEDB2";
            string tableName2 = "MIKE.TESTTABLEDB2_02";
            ...
            try
            {
                db2.ServerName = frm.txtServerName.Text;
                db2.DatabaseName = frm.txtDatabaseName.Text;
                db2.Username = frm.txtUsername.Text;
                db2.Password = frm.txtPassword.Text;
                ...
                {
                    bool dropped = db2.DropTable(tableName);
                    if (dropped == false)
                    {
                        _msg.Length = 0;
                ...
                if (db2.TableExists(tableName2))
                {
                    bool dropped = db2.DropTable(tableName2);
                    if (dropped == false)
                    {
                        _msg.Length = 0;
                        _msg.Append("Unable to drop table ");
                ...
                IDatabaseProvider db = (IDatabaseProvider)db2;
                ...
                dataTypesToInclude.Add(new KeyValuePair<string, string>("System.Byte", "254"));  //db2 .net provider not able to deal with this data type: data type is changed by unit test class to a char
                dataTypesToInclude.Add(new KeyValuePair<string, string>("System.SByte", "125")); //db2 .net provider not able to deal with this data type: data type is changed by unit test class to a char
                dataTypesToInclude.Add(new KeyValuePair<string, string>("System.Byte[]", "LMNOPQRSTUVWZYZ"));
                dataTypesToInclude.Add(new KeyValuePair<string, string>("System.Boolean", "True")); //db2 .net provider not able to deal with this data type: data type is changed by unit test class to a Int16
                ...
                dataTypesToInclude.Add(new KeyValuePair<string, string>("System.Guid", "58a4a08d-6101-4393-86dc-b2a8db46ec0f")); //db2 .net provider not able to deal with this data type: data type is changed by unit test class to a string
                ...
                bool result = db2.CreateTable(dt, out createScript);
                */
        ...
        public static void DataReaderTest(MainForm frm)
        {
            ...
            try
            {
                ...
                sw.Start();
                DB2DataReader rdr = (DB2DataReader)db.RunQueryDataReader();
                ...
                sw.Start();
                rdr = (DB2DataReader)db.RunQueryDataReader();
