    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkCreateProviderObjects.Checked)
                {
                    nNumTestsSelected++;
                    Tests.CreateProviderObjects(this);
                }

                if (this.chkCreateConnectionObjects.Checked)
                {
                    nNumTestsSelected++;
                    Tests.CreateConnectionObjects(this);
                }

                if (this.chkShowConnectionPromptForm.Checked)
                {
                    nNumTestsSelected++;
                    Tests.ShowConnectionPromptForm(this);
                }

                if (this.chkUpdateProviderObjects.Checked)
                {
                    nNumTestsSelected++;
                    Tests.UpdateProviderObjects(this);
                }

                if (this.chkShowDatabaseSelector.Checked)
                {
                    nNumTestsSelected++;
                    Tests.ShowDatabaseSelector(this);
                }

                if (this.chkShowConnectionStringDefinitionsForm.Checked)
                {
                    nNumTestsSelected++;
                    Tests.ShowConnectionStringDefinitionsForm(this);
                }
