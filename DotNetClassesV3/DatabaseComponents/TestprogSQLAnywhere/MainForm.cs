...
namespace TestprogSQLAnywhere
{
    public partial class MainForm : Form
    {
        ...
        private string _saveFilter = "Database Files|*.db|UltraLite Database Files|*.udb|DataFiles|*txt;*.dat|All Files|*.*";
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.txtSchemaName.Text = "dba";

                _str.Length = 0;
                _str.Append("Select CurrencyKey as PK ,CurrencyAlternateKey as AK, CurrencyName");
                _str.Append("  from DBA.DimCurrency");
                _str.Append("");
        ...
        private void LoadAppConfigItems()
        {
            ...
            DataTable dt = keyValsDataSet.Tables["dba.KeyValTable"];
            dt.Clear();
        ...
        public void RunQueryBuilder()
        {
            ...
            try
            {
                ...
                qbf.DatabasePlatform = QueryBuilderDatabasePlatform.SQLAnywhere;
        ...
        private string GetConnectionString()
        {
            ...
            try
            {
                ...
                db.DataSourceName = this.txtDataSource.Text;
                ...
                db.EncryptedPassword = this.txtEncryptedPassword.Text;
                db.Encryption = this.txtEncryption.Text;
