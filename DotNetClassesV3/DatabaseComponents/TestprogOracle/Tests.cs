    ...
    public class Tests
    {
        ...
        public static void CreateTableTest(MainForm frm)
        {
            ...
            try
            {
                ...
                //sql.Append("    IF SQLCODE != 942 and SQLCODE != 6512 then\r\n");
                //sql.Append("       RAISE;\r\n");
                //sql.Append("    END IF;\r\n");
                //sql.Append("END;");
        ...
        public static void DataReaderTest(MainForm frm)
        {
            ...
            try
            {
                ...
                oracle.returnResultAsString += new PFOracle.ResultAsStringDelegate(OutputResultsToFile);
        ...
        public static void DataTableTest(MainForm frm)
        {
            ...
            try
            {
                ...
                oracle.returnResult += new PFOracle.ResultDelegate(OutputResults);
                ...
                //oracle.returnResultAsString += new PFOracle.ResultAsStringDelegate(OutputExtractFormattedData);
                oracle.returnResultAsString += new PFOracle.ResultAsStringDelegate(OutputResultsToFile);
