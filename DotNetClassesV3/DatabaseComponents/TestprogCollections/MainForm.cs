...
namespace TestprogCollections
{
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            Tests testApp = new Tests();

            try
            {
                DisableFormControls();
                testApp.SaveErrorMessagesToAppLog = _saveErrorMessagesToAppLog;
                ...
                if (this.chkGenericListTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.GenericListTest();
                }

                if (this.chkGenericKeyValueListTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.GenericKeyValueListTest();
                }

                if (this.chkToXmlTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.ToXmlTest();
                }

                if (this.chkListMergeTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.ListMergeTest();
                }

                if (this.chkKeyValueListMergeTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.KeyValueListMergeTest();
                }

                if (this.chkGenericSortedKeyValueListTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.GenericSortedKeyValueListTest();
                }

                if (this.chkSortedKeyValueListMergeTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.SortedKeyValueListMergeTest();
                }

                if (this.chkRandomizeListsTest.Checked)
                {
                    nNumTestsSelected++;
                    testApp.RandomizeListsTest();
                }
