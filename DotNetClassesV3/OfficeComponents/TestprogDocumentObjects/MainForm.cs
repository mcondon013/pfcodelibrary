    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                {
                    nNumTestsSelected++;
                    _appProcessor.OutputToExcelDocument();
                }

                if (this.chkExportDataFromExcelDocument.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.ExportDataFromExcelDocument();
                }

                if (this.chkOutputToWordDocument.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.OutputToWordDocument();
                }

                if (this.chkOutputToRTFDocument.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.OutputToRTFDocument(this);
                }

                if (this.chkOutputToPDFDocument.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.OutputToPDFDocument(this);
                }
