...
{
    /// <summary>
    /// Class for generating PDF documents. Requires GemBox Document third party product license and client software to work.
    /// </summary>
    public class PFPDFDocument
    {
        ...
        public PFPDFDocument(string documentFilePath)
        {
        ...
        public PFPDFDocument(string documentFilePath, bool replaceExistingFile)
        {
            _documentFilePath = documentFilePath;
        ...
        /// <summary>
        /// Specifies path to the PDF document on disk.
        /// </summary>
        ...
        public bool WriteDataToDocument(DataTable dt)
        {
            ...
            try
            {
                wordDoc = new PFWordInterop(enWordOutputFormat.PDF, this.DocumentFilePath, this.ReplaceExistingFile);
            ...
            catch (System.Exception ex)
            {
                success = false;
                _msg.Length = 0;
                _msg.Append("Attempt to import DataTable into PDF document failed. ");
